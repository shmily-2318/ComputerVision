...
class BaseFrame(tk.Frame):
    ...
    def __init__(self, parent, root):
        ...
        self.keypointOptions = tk.OptionMenu(self, self.keypointTypeVar, 'Harris', 'ORB', 'Dummy')
        ...
        self.descriptorOptions = tk.OptionMenu(self, self.descriptorTypeVar, 'MOPS', 'ORB', 'Simple', 'Custom')
        ...
        self.matcherOptions = tk.OptionMenu(self, self.matcherTypeVar, 'Ratio Test', 'SSD', 'ORB')
    ...
    def updateMatchCount(self, percent):
        if self.matches is not None:
            ...
            if len(matches) == 0:
                ...
                matchImage = self.drawMatches(self.image[0], self.thresholdedKeypoints[0],
                                              self.image[1], self.thresholdedKeypoints[1],
                                              matches)
